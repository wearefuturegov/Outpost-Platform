...
})({"eQlhA":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b70f39c4c38f9027";
"use strict";
...
},{}],"kCZqk":[function(require,module,exports) {
...
const setC4Type = function(c4TypeParam) {
    let sanitizedText = (0, _config389B86FfJs.b)(c4TypeParam, (0, _config389B86FfJs.g)());
...
const getBoundarys = function(parentBoundary) {
    if (parentBoundary === void 0 || parentBoundary === null) return boundarys;
...
const setTitle = function(txt) {
    let sanitizedText = (0, _config389B86FfJs.b)(txt, (0, _config389B86FfJs.g)());
    title = sanitizedText;
};
const c4Db = {
    addPersonOrSystem,
    ...
    parseDirective,
    getConfig: ()=>(0, _config389B86FfJs.g)().c4,
    clear,
    LINETYPE,
    ARROWTYPE,
    PLACEMENT,
...
const drawImage = function(elem, width, height, x, y, link) {
    ...
    imageElem.attr("x", x);
    imageElem.attr("y", y);
    let sanitizedLink = link.startsWith("data:image/png;base64") ? link : (0, _sanitizeUrl.sanitizeUrl)(link);
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
    if (!c4Shape[textType].width) {
        if (c4ShapeTextWrap) {
            c4Shape[textType].text = (0, _utilsD5Eeff82Js.w)(c4Shape[textType].text, textLimitWidth, textConf);
            c4Shape[textType].textLines = c4Shape[textType].text.split((0, _config389B86FfJs.d).lineBreakRegex).length;
            c4Shape[textType].width = textLimitWidth;
            c4Shape[textType].height = (0, _utilsD5Eeff82Js.k)(c4Shape[textType].text, textConf);
        } else {
            let lines = c4Shape[textType].text.split((0, _config389B86FfJs.d).lineBreakRegex);
            c4Shape[textType].textLines = lines.length;
            let lineHeight = 0;
            c4Shape[textType].height = 0;
            c4Shape[textType].width = 0;
            for (const line of lines){
                c4Shape[textType].width = Math.max((0, _utilsD5Eeff82Js.j)(line, textConf), c4Shape[textType].width);
                lineHeight = (0, _utilsD5Eeff82Js.k)(line, textConf);
...
const drawBoundary = function(diagram2, boundary, bounds) {
    ...
    let textLimitWidth = (0, _utilsD5Eeff82Js.j)(boundary.label.text, boundaryLabelConf);
...
const drawC4ShapeArray = function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
    ...
    for (const c4ShapeKey of c4ShapeKeys){
        ...
        c4Shape.typeC4Shape.width = (0, _utilsD5Eeff82Js.j)("<<" + c4Shape.typeC4Shape.text + ">>", c4ShapeTypeConf);
...
const drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
    ...
    for (let rel of rels2){
        ...
        let textLimitWidth = (0, _utilsD5Eeff82Js.j)(rel.label.text, relConf);
        calcC4ShapeTextWH("label", rel, relTextWrap, relConf, textLimitWidth);
        if (rel.techn && rel.techn.text !== "") {
            textLimitWidth = (0, _utilsD5Eeff82Js.j)(rel.techn.text, relConf);
            calcC4ShapeTextWH("techn", rel, relTextWrap, relConf, textLimitWidth);
        }
        if (rel.descr && rel.descr.text !== "") {
            textLimitWidth = (0, _utilsD5Eeff82Js.j)(rel.descr.text, relConf);
...
function drawInsideBoundary(diagram2, parentBoundaryAlias, parentBounds, currentBoundaries, diagObj) {
    ...
    for (let [i, currentBoundary] of currentBoundaries.entries()){
        ...
        if (nextCurrentBoundarys.length > 0) drawInsideBoundary(diagram2, parentBoundaryAlias, currentBounds, nextCurrentBoundarys, diagObj);
...
const draw = function(_text, id, _version, diagObj) {
    ...
    (0, _config389B86FfJs.l).debug(`C:${JSON.stringify(conf, null, 2)}`);
    ...
    (0, _config389B86FfJs.l).debug(`models:`, box);
};
const c4Renderer = {
...
},{"./mermaidAPI-0716c7c2.js":"bdkW7","./config-389b86ff.js":"hnpRM","./commonDb-2ace122b.js":"kBdnX","d3":"17XFv","@braintree/sanitize-url":"hrxAd","./utils-d5eeff82.js":"2zv2d","./setupGraphViewbox-e35e4124.js":"jv1OR","stylis":"bMCXt","./errorRenderer-d05351b9.js":"d3Vzc","dompurify":"9Kzno","lodash-es/isEmpty.js":"e1Kmi","dayjs":"NJZFB","khroma":"lMw0x","lodash-es/memoize.js":"5zdei","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kBdnX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"d3":"17XFv","./config-389b86ff.js":"hnpRM","./utils-d5eeff82.js":"2zv2d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eQlhA"], null, "parcelRequire54bf")

//# sourceMappingURL=c4Diagram-f9e67060.c38f9027.js.map
