...
})({"ctELx":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7bec64ab83ea33f1";
"use strict";
...
},{}],"eZ7lh":[function(require,module,exports) {
...
const sanitizeText = (txt)=>(0, _config389B86FfJs.d).sanitizeText(txt, (0, _config389B86FfJs.g)());
let conf = {
    dividerMargin: 10,
    padding: 5,
    textHeight: 10,
...
const addClasses = function(classes, g, _id, diagObj) {
    ...
    (0, _config389B86FfJs.l).info("keys:", keys);
    (0, _config389B86FfJs.l).info(classes);
    keys.forEach(function(id) {
        ...
        const node = {
            ...
            padding: ((_a = (0, _config389B86FfJs.g)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0, _config389B86FfJs.g)().class) == null ? void 0 : _b.padding)
        };
        g.setNode(vertex.id, node);
        (0, _config389B86FfJs.l).info("setNode", node);
    });
};
const addNotes = function(notes, g, startEdgeId, classes) {
    (0, _config389B86FfJs.l).info(notes);
    notes.forEach(function(note, i) {
        ...
        const edgeData = {
            ...
            style: "fill:none",
            labelStyle: "",
            curve: (0, _utilsD5Eeff82Js.n)(conf.curve, (0, _d3.curveLinear))
        };
        g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
    });
};
const addRelations = function(relations, g) {
    const conf2 = (0, _config389B86FfJs.g)().flowchart;
    let cnt = 0;
    relations.forEach(function(edge) {
        ...
        const edgeData = {
            ...
            style: "fill:none",
            labelStyle: "",
            curve: (0, _utilsD5Eeff82Js.n)(conf2 == null ? void 0 : conf2.curve, (0, _d3.curveLinear))
        };
        (0, _config389B86FfJs.l).info(edgeData, edge);
        if (edge.style !== void 0) {
            const styles2 = (0, _utilsD5Eeff82Js.m)(edge.style);
        ...
        if (edge.text === void 0) {
            ...
            edgeData.labelpos = "c";
            if (((_a = (0, _config389B86FfJs.g)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0, _config389B86FfJs.g)().htmlLabels) {
...
const draw = function(text, id, _version, diagObj) {
    (0, _config389B86FfJs.l).info("Drawing class - ", id);
    const conf2 = (0, _config389B86FfJs.g)().flowchart ?? (0, _config389B86FfJs.g)().class;
    const securityLevel = (0, _config389B86FfJs.g)().securityLevel;
    (0, _config389B86FfJs.l).info("config:", conf2);
    ...
    (0, _config389B86FfJs.l).info(relations);
    ...
    (0, _utilsD5Eeff82Js.u).insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
    (0, _setupGraphViewboxE35E4124Js.s)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
},{"d3":"17XFv","./utils-d5eeff82.js":"2zv2d","./config-389b86ff.js":"hnpRM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ctELx"], null, "parcelRequire54bf")

//# sourceMappingURL=classDiagram-v2-539b00ca.83ea33f1.js.map
