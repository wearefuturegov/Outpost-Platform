...
})({"eK8Qx":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "50a42df63091183a";
"use strict";
...
},{}],"24695":[function(require,module,exports) {
...
const getClasses = function(text, diagramObj) {
    (0, _config389B86FfJs.l).trace("Extracting classes");
    diagramObj.db.clear();
    try {
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag)=>{
    ...
    if (itemId !== "root") {
        ...
        if (parsedItem.type !== (0, _stylesD6Bd7A5EJs.a)) shape = parsedItem.type;
        if (!nodeDb[itemId]) nodeDb[itemId] = {
            id: itemId,
            shape,
            description: (0, _config389B86FfJs.d).sanitizeText(itemId, (0, _config389B86FfJs.g)()),
        ...
        if (parsedItem.description) {
            ...
            newNode.description = (0, _config389B86FfJs.d).sanitizeTextOrArray(newNode.description, (0, _config389B86FfJs.g)());
        }
        if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) newNode.shape = SHAPE_STATE;
        if (!newNode.type && parsedItem.doc) {
            (0, _config389B86FfJs.l).info("Setting cluster for ", itemId, getDir(parsedItem));
            newNode.type = "group";
            newNode.dir = getDir(parsedItem);
            newNode.shape = parsedItem.type === (0, _stylesD6Bd7A5EJs.b) ? SHAPE_DIVIDER : SHAPE_GROUP;
    ...
    if (parent && parent.id !== "root") {
        (0, _config389B86FfJs.l).trace("Setting node ", itemId, " to be child of its parent ", parent.id);
        g.setParent(itemId, parent.id);
    }
    if (parsedItem.doc) {
        (0, _config389B86FfJs.l).trace("Adding nodes children ");
        setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
    }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag)=>{
    (0, _config389B86FfJs.l).trace("items", doc);
    doc.forEach((item)=>{
        switch(item.stmt){
            case 0, _stylesD6Bd7A5EJs.c:
                setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
                break;
            case 0, _stylesD6Bd7A5EJs.a:
                setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
                break;
            case 0, _stylesD6Bd7A5EJs.S:
                {
                    ...
                    const edgeData = {
                        ...
                        style: G_EDGE_STYLE,
                        labelStyle: "",
                        label: (0, _config389B86FfJs.d).sanitizeText(item.description, (0, _config389B86FfJs.g)()),
                        arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
                        labelpos: G_EDGE_LABELPOS,
                        labelType: G_EDGE_LABELTYPE,
                        thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = (0, _stylesD6Bd7A5EJs.e))=>{
    let dir = defaultDir;
...
const draw = function(text, id, _version, diag) {
    (0, _config389B86FfJs.l).info("Drawing state diagram (v2)", id);
    nodeDb = {};
    let dir = diag.db.getDirection();
    if (dir === void 0) dir = (0, _stylesD6Bd7A5EJs.D);
    const { securityLevel , state: conf  } = (0, _config389B86FfJs.g)();
    const nodeSpacing = conf.nodeSpacing || 50;
    const rankSpacing = conf.rankSpacing || 50;
    (0, _config389B86FfJs.l).info(diag.db.getRootDocV2());
    ...
    const padding = 8;
    (0, _utilsD5Eeff82Js.u).insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
...
},{"./styles-d6bd7a5e.js":"1JAnq","dagre-d3-es/src/graphlib/index.js":"2nAwO","d3":"17XFv","./config-389b86ff.js":"hnpRM","./index-f9d09cc9.js":"bMWir","./setupGraphViewbox-e35e4124.js":"jv1OR","./utils-d5eeff82.js":"2zv2d","./mermaidAPI-0716c7c2.js":"bdkW7","stylis":"bMCXt","./errorRenderer-d05351b9.js":"d3Vzc","dompurify":"9Kzno","lodash-es/isEmpty.js":"e1Kmi","./commonDb-2ace122b.js":"kBdnX","dayjs":"NJZFB","khroma":"lMw0x","dagre-d3-es/src/dagre/index.js":"g6zYa","dagre-d3-es/src/graphlib/json.js":"iUA0H","./edges-65da65dc.js":"i9uQ2","./svgDraw-6a237a99.js":"hHKQv","@braintree/sanitize-url":"hrxAd","lodash-es/memoize.js":"5zdei","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jv1OR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"d3":"17XFv","./utils-d5eeff82.js":"2zv2d","./config-389b86ff.js":"hnpRM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eK8Qx"], null, "parcelRequire54bf")

//# sourceMappingURL=stateDiagram-v2-1cc5d8ed.3091183a.js.map
