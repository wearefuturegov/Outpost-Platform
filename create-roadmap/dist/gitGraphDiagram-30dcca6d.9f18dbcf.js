...
})({"hx6Ro":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "039fef309f18dbcf";
"use strict";
...
},{}],"e3aEH":[function(require,module,exports) {
...
let mainBranchName = (0, _config389B86FfJs.g)().gitGraph.mainBranchName;
let mainBranchOrder = (0, _config389B86FfJs.g)().gitGraph.mainBranchOrder;
let commits = {};
let head = null;
let branchesConfig = {};
...
const setOptions = function(rawOptString) {
    (0, _config389B86FfJs.l).debug("options str", rawOptString);
    rawOptString = rawOptString && rawOptString.trim();
    rawOptString = rawOptString || "{}";
    try {
        options = JSON.parse(rawOptString);
    } catch (e) {
        (0, _config389B86FfJs.l).error("error while parsing gitGraph options", e.message);
    }
};
...
const commit = function(msg, id, type, tag) {
    (0, _config389B86FfJs.l).debug("Entering commit:", msg, id, type, tag);
    id = (0, _config389B86FfJs.d).sanitizeText(id, (0, _config389B86FfJs.g)());
    msg = (0, _config389B86FfJs.d).sanitizeText(msg, (0, _config389B86FfJs.g)());
    tag = (0, _config389B86FfJs.d).sanitizeText(tag, (0, _config389B86FfJs.g)());
    const commit2 = {
        id: id ? id : seq + "-" + getId(),
        message: msg,
        seq: seq++,
    ...
    (0, _config389B86FfJs.l).debug("in pushCommit " + commit2.id);
};
const branch = function(name, order) {
    name = (0, _config389B86FfJs.d).sanitizeText(name, (0, _config389B86FfJs.g)());
    if (branches[name] === void 0) {
        ...
        checkout(name);
        (0, _config389B86FfJs.l).debug("in createBranch");
    } else {
...
const merge = function(otherBranch, custom_id, override_type, custom_tag) {
    otherBranch = (0, _config389B86FfJs.d).sanitizeText(otherBranch, (0, _config389B86FfJs.g)());
    custom_id = (0, _config389B86FfJs.d).sanitizeText(custom_id, (0, _config389B86FfJs.g)());
    ...
    commits[commit2.id] = commit2;
    branches[curBranch] = commit2.id;
    (0, _config389B86FfJs.l).debug(branches);
    (0, _config389B86FfJs.l).debug("in mergeBranch");
};
const cherryPick = function(sourceId, targetId, tag) {
    (0, _config389B86FfJs.l).debug("Entering cherryPick:", sourceId, targetId, tag);
    sourceId = (0, _config389B86FfJs.d).sanitizeText(sourceId, (0, _config389B86FfJs.g)());
    targetId = (0, _config389B86FfJs.d).sanitizeText(targetId, (0, _config389B86FfJs.g)());
    tag = (0, _config389B86FfJs.d).sanitizeText(tag, (0, _config389B86FfJs.g)());
    ...
    if (!targetId || commits[targetId] === void 0) {
        ...
        branches[curBranch] = commit2.id;
        (0, _config389B86FfJs.l).debug(branches);
        (0, _config389B86FfJs.l).debug("in cherryPick");
    }
};
const checkout = function(branch2) {
    branch2 = (0, _config389B86FfJs.d).sanitizeText(branch2, (0, _config389B86FfJs.g)());
...
function prettyPrintCommitHistory(commitArr) {
    ...
    (0, _config389B86FfJs.l).debug(label.join(" "));
...
const prettyPrint = function() {
    (0, _config389B86FfJs.l).debug(commits);
...
const clear$1 = function() {
    commits = {};
    head = null;
    let mainBranch = (0, _config389B86FfJs.g)().gitGraph.mainBranchName;
    let mainBranchOrder2 = (0, _config389B86FfJs.g)().gitGraph.mainBranchOrder;
    branches = {};
...
const getBranchesAsObjArray = function() {
    ...
    }).sort((a, b)=>a.order - b.order).map(({ name  })=>({
            name
        }));
...
const getCommitsArray = function() {
    ...
    commitArr.forEach(function(o) {
        (0, _config389B86FfJs.l).debug(o.id);
    });
...
const gitGraphDb = {
    parseDirective,
    getConfig: ()=>(0, _config389B86FfJs.g)().gitGraph,
    setDirection,
    setOptions,
    getOptions,
    commit,
...
const drawCommits = (svg, commits2, modifyGraph)=>{
    const gitGraphConfig = (0, _utilsD5Eeff82Js.q)().gitGraph;
...
const drawArrow = (svg, commit1, commit2, allCommits)=>{
    ...
    if (overlappingCommits) {
        ...
        if (p1.y < p2.y) lineDef = `M ${p1.x} ${p1.y} L ${p1.x} ${lineY - radius} ${arc} ${p1.x + offset} ${lineY} L ${p2.x - radius} ${lineY} ${arc2} ${p2.x} ${lineY + offset} L ${p2.x} ${p2.y}`;
        else lineDef = `M ${p1.x} ${p1.y} L ${p1.x} ${lineY + radius} ${arc2} ${p1.x + offset} ${lineY} L ${p2.x - radius} ${lineY} ${arc} ${p2.x} ${lineY - offset} L ${p2.x} ${p2.y}`;
    } else {
        if (p1.y < p2.y) {
            arc = "A 20 20, 0, 0, 0,";
            radius = 20;
...
const draw = function(txt, id, ver, diagObj) {
    clear();
    const conf = (0, _utilsD5Eeff82Js.q)();
    const gitGraphConfig = conf.gitGraph;
    (0, _config389B86FfJs.l).debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
    ...
    const diagram2 = (0, _d3.select)(`[id="${id}"]`);
    drawCommits(diagram2, allCommitsDict, false);
    if (gitGraphConfig.showBranches) drawBranches(diagram2, branches2);
    drawArrows(diagram2, allCommitsDict);
    drawCommits(diagram2, allCommitsDict, true);
    (0, _utilsD5Eeff82Js.u).insertTitle(diagram2, "gitTitleText", gitGraphConfig.titleTopMargin, diagObj.db.getDiagramTitle());
    (0, _utilsD5Eeff82Js.s)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth ?? conf.useMaxWidth);
};
...
},{"./config-389b86ff.js":"hnpRM","./utils-d5eeff82.js":"2zv2d","./mermaidAPI-0716c7c2.js":"bdkW7","./commonDb-2ace122b.js":"kBdnX","d3":"17XFv","dompurify":"9Kzno","dayjs":"NJZFB","khroma":"lMw0x","@braintree/sanitize-url":"hrxAd","./setupGraphViewbox-e35e4124.js":"jv1OR","lodash-es/memoize.js":"5zdei","stylis":"bMCXt","./errorRenderer-d05351b9.js":"d3Vzc","lodash-es/isEmpty.js":"e1Kmi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kBdnX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"d3":"17XFv","./config-389b86ff.js":"hnpRM","./utils-d5eeff82.js":"2zv2d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hx6Ro"], null, "parcelRequire54bf")

//# sourceMappingURL=gitGraphDiagram-30dcca6d.9f18dbcf.js.map
